...
`AiiDA <https://www.aiida.net/>`_  is a workflow management framework facilitating automation, sharing and reproduction of complex workflows across
...
full data provenance to improve reproducibility. A more detailed guide on the core concepts of AiiDA can be found
